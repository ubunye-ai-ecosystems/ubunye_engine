...
└── tests/
    ...
    └── test_transformations.py             7 pandas unit tests
```
...
The unit tests exercise `transform_weather_pandas` against a hand-built
Open-Meteo response fixture - no Spark or network needed.
